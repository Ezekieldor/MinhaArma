...
{
    public class RequisitarP4ViewModel : MvxViewModel<User>
    {
        ...
        public RequisitarP4ViewModel(IMvxPictureChooserTask pictureChooserTask, IMvxNavigationService navigationService)
        {
        ...
        public async void DoEntrarAsync()
        {
            ...
            {
                uploadImage(imageComprovante, 6);

                await _navigationService.Close(this);
                await _navigationService.Navigate<RequisitarP5ViewModel, User>(userParameter);
            }
        }
    }
}
